...
import com.jacaranda.trd.exception.TokenNotValid;
	...
	// Declaramos el token que usaremos para el cifrado y la decodificación.
		    ...
		    public static UsernamePasswordAuthenticationToken getAuthentication(String token) throws JwtException, IllegalArgumentException, NoSuchAlgorithmException   {
		    	...
		    	if (!token.startsWith("Bearer ")) {
					throw new TokenNotValid("Formato token no válido");
		    	}
		    	...
		    	try {
		    		...
		    		throw new TokenNotValid("Imposible encontra un JWT Token");
	            } catch (ExpiredJwtException e) {
	            	throw new TokenNotValid("Token expirado");
	            } catch (NoSuchAlgorithmException e) {
					throw new TokenNotValid("Algoritmo no válido");
	            }
